...
def exercise():
  print("Write a program that asks how many kilometers a car has driven and the number of days it has been rented. Calculate the price to pay, knowing that the car costs R$60 per day and R$ 0.15 per km driven.\n")
